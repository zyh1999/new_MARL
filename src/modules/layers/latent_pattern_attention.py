...
class ScaledDotProductLatentPatternAttention(nn.Module):
...
class MultiHeadLatentPatternAttention(nn.Module):
    def __init__(self, emb_dim, n_heads, rnn_hidden_dim, dropout_attn=0.0, dropout_attn_out=0.0):
        ...
        self.attention = ScaledDotProductLatentPatternAttention(temperature=emb_dim ** 0.5, dropout_attn=dropout_attn)
...
class LatentPatternTransformerBlock(nn.Module):

    def __init__(self, emb_dim, n_heads, ff_emb_dim, rnn_hidden_dim, dropout_attn=0.0, dropout_attn_out=0.0, dropout_ff=0.0):
        super().__init__()

        self.attn = MultiHeadLatentPatternAttention(emb_dim, n_heads, rnn_hidden_dim, dropout_attn, dropout_attn_out)
...
class LatentPatternTransformer(nn.Module):
    ...
    def __init__(self, n_blocks, emb_dim, n_heads, ff_emb_dim, rnn_hidden_dim,
        ...
        self.transformer_blocks = nn.Sequential(*[
            LatentPatternTransformerBlock(emb_dim, n_heads, ff_emb_dim, rnn_hidden_dim, dropout_attn, dropout_attn_out, dropout_ff)

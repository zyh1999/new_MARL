...
class ScaledDotProductPatternAttention(nn.Module):
...
class MultiHeadPatternAttention(nn.Module):
    def __init__(self, emb_dim, n_heads, dropout_attn=0.0, dropout_attn_out=0.0):
        ...
        self.attention = ScaledDotProductPatternAttention(temperature=emb_dim ** 0.5, dropout_attn=dropout_attn)
...
class PatternTransformerBlock(nn.Module):

    def __init__(self, emb_dim, n_heads, ff_emb_dim, dropout_attn=0.0, dropout_attn_out=0.0, dropout_ff=0.0):
        super().__init__()

        self.attn = MultiHeadPatternAttention(emb_dim, n_heads, dropout_attn, dropout_attn_out)
...
class PatternTransformer(nn.Module):
    ...
    def __init__(self, n_blocks, emb_dim, n_heads, ff_emb_dim,
        ...
        self.transformer_blocks = nn.Sequential(*[
            PatternTransformerBlock(emb_dim, n_heads, ff_emb_dim, dropout_attn, dropout_attn_out, dropout_ff)

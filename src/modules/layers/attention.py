...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, emb_dim, n_heads, ff_emb_dim, dropout_attn=0.0, dropout_attn_out=0.0, dropout_ff=0.0):
        ...
        self.attn = MultiHeadAttention(emb_dim, n_heads, dropout_attn, dropout_attn_out)
...
class Transformer(nn.Module):
    ...
    def __init__(self, n_blocks, emb_dim, n_heads, ff_emb_dim,
        ...
        self.transformer_blocks = nn.Sequential(*[
            TransformerBlock(emb_dim, n_heads, ff_emb_dim, dropout_attn, dropout_attn_out, dropout_ff)

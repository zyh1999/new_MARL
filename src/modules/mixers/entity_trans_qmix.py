...
class EntityTransQMixer(nn.Module):
    def __init__(self, args):
        super(EntityTransQMixer, self).__init__()
        ...
        self.transformer = Transformer(args.mix_n_blocks, args.mix_emb_dim, args.mix_n_heads, args.mix_emb_dim * 4)

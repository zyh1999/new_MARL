...
from modules.layers import SpotlightTransformer


class EntitySpotlightTransQMixer(nn.Module):
    def __init__(self, args):
        super(EntitySpotlightTransQMixer, self).__init__()
        ...
        self.transformer = SpotlightTransformer(args.mix_n_blocks, args.mix_emb_dim, args.mix_n_heads, args.mix_emb_dim * 4)

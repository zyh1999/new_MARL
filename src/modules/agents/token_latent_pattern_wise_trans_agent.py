...
from modules.layers import LatentPatternTransformer


class TokenLatentPatternWiseTransAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(TokenLatentPatternWiseTransAgent, self).__init__()
        self.args = args
        self.x_shape = None

        self.token_embedding = nn.Linear(input_shape, args.emb_dim)
        self.transformer = LatentPatternTransformer(args.n_blocks, args.emb_dim, args.n_heads, args.emb_dim * 4, args.rnn_hidden_dim)

...
from modules.layers import SparseTransformer


class EntitySparseTransAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(EntitySparseTransAgent, self).__init__()
        self.args = args

        self.entity_embedding = nn.Linear(input_shape, args.emb_dim)
        self.transformer = SparseTransformer(args.n_blocks, args.emb_dim, args.n_heads, args.emb_dim * 4)
